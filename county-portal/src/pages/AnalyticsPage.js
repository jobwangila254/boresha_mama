            ...
            <div style={styles.funnelContainer}>
              <div style={styles.funnelItem}>
                <div style={styles.funnelBarOuter}>
                  <div style={{ ...styles.funnelBar, width: '100%', background: '#3498DB' }} />
                </div>
        ...
        <div style={styles.chartCard}>
          ...
          {stats ? (
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie data={[
                  { name: 'Low Risk', value: Math.max((stats.activePregnancies || 0) - (stats.highRiskPregnancies || 0), 0) },
                  { name: 'High Risk', value: stats.highRiskPregnancies || 0 },
