  ...
  function renderCHVRow(user) {
    ...
    return (
      <tr key={user.id} onClick={() => setSelectedUser(user)} style={styles.trClickable}>
        ...
        <td style={styles.td}>{user.national_id || '—'}</td>
          ...
          <table style={styles.table}>
            <thead>
              <tr>
                <th style={styles.th}>{t('name')}</th>
                <th style={styles.th}>{t('phone')}</th>
                <th style={styles.th}>{t('national_id')}</th>
            ...
            <form onSubmit={handleAddUser}>
              ...
              <div style={styles.formGrid}>
                <div style={styles.field}>
                  ...
                  <input style={styles.input} value={form.chvRegistrationNumber} onChange={e => setForm({ ...form, chvRegistrationNumber: e.target.value })} placeholder="e.g. CHV/TRANS-NZOIA/001" required />
                </div>
                <div style={styles.field}>
